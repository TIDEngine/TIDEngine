...
define('DIR_ROOT', '/Applications/XAMPP/xamppfiles/htdocs/TIDEngine/');
//Root http of the site
define('HTTP_ROOT', 'http://localhost/TIDEngine/'); // or http://example.com/blog
//Directory for saving images
define('DIR_IMAGES',  'inc/uploads/images');
//Directory for saving files
define('DIR_FILES',  'inc/uploads/files');

...
jQuery(document).ready(function($) {
    ...
    $('#pages ul li a').click(function (e) {
        ...
        $(this).stop().css("background-color","cornflowerblue")
    ...
    function call(r){
        $.ajax({
            ...
            error:function(){
                showResponse('Error processing request');
            }
...
function showResponse(responseText)  {
    ...
    $('#facebookG').delay(1000).hide(0,function(){
        $('#admin_content').html(responseText).fadeIn();
    })
}
...
//    cmsURL = "http://localhost/TIDEngine/inc/vendor/editors/tinymce/plugins/elustrofm/index.html?integration=fm&lang="+ed.settings.language+"&filetype="+type+"&filedname="+field_name+"&windows="+win;
...
//        if(!moxman.ui){
//        ResourceLoader.load({
//            js:[Env.baseUrl+"/js/moxman.api.min.js",Env.baseUrl+"/api.php?action=language"+(settings.language?"&code="+settings.language:""),Env.baseUrl+"/api.php?action=PluginJs"],
